...
// Each entry is framed as a directory the listing would have printed. The names are too long
...
/**
 * `education` — school, degree, dates, and nothing after them. A GPA and a coursework list
 * are what a transcript is for; on a portfolio they only push the projects further down.
 *
 * The logo sits on white because the mark is drawn for a light ground and would otherwise
 * lose its outline against the terminal.
 */
export default function Education() {
  return (
    <Section id="education" command="education" label="Education">
