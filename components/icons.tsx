...
// Store marks (Simple Icons, CC0). Filled, not stroked: these are logos, not glyphs.
export function AppStoreIcon(p: P) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...base} {...p}>
...
export function GooglePlayIcon(p: P) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...base} {...p}>
