 ...
 * with a screenshot and a paragraph each, lives on /work behind the "view all work" link.
 * GasMap leads and wears a star; it does not get its own width.
 *
 * The section is `work` and the route is /work — the heading names what these are,
