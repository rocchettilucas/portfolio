...
export type Project = {
  ...
  description: string[];    // what the product is, in 1-3 short sentences for /work, one per array item
  ...
  dates: string;            // when it was worked on, resume-style ("Jun 2026 – present"), or a single month
...
export const projects: Project[] = [
  {
    ...
    description: [
      "A gas-price app for Ontario drivers that tracks live gas prices and price trends across more than 3,000 stations.",
  ...
  },
  {
    ...
    description: [
      "An open-source macOS agentic developer environment for running AI coding agents like Claude Code and Codex alongside regular shell sessions.",
      "Supports up to 16 terminal sessions per workspace.",
    ],
  ...
  },
  {
    ...
    description: [
      "A data-driven web application for the game League of Legends that utilizes algorithmic match analysis across various in-game metrics to recommend the most optimal champion selections for any lane.",
    ],
  ...
  },
  {
    ...
    dates: "Apr 2026",
    blurb: "An analytics dashboard for searching 23,000+ NHL players and exploring their career statistics and game-by-game performance.",
    description: [
      "An interactive NHL analytics dashboard with player search, performance comparisons, live scores, career statistics and game-by-game trends.",
    ],
    image: "/projects/nhl-shot.webp",
    tech: ["React", "JavaScript", "Recharts", "NHL API"],
    links: {
      github: "https://github.com/rocchettilucas/NHL-Player-Dashboard",
      site: "https://nhl-player-dashboard.vercel.app",
    },
  ...
  },
  {
    ...
    description: [
      "A research-opportunity platform connecting undergraduate students across five Canadian universities with professors and mentors, featuring 1,500+ professor profiles and 500+ scholarships.",
    ],
  ...
  // undefined and the card falls back to the folder glyph the listing already draws.
  {
    ...
    description: [
      "A round-based first-person shooter where you survive escalating waves of zombies and unlock new weapons inside an overrun office building.",
    ],
    ...
    description: [
      "A first-person simulator game where you play as a night-shift janitor clearing trash and spills in an empty high school hallway.",
    ],
...
export const experience: Role[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "Coordinate facility teams and event staff for crowds of 5,000+ attendees.",
    ],
  },
];
